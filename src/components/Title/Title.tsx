...
function Title() {
  ...
  return (
    <div className="grid grid-rows-2 grid-flow-col gap-4 m-20">
      <div className="row-start-1 flex justify-start">
        <img src={images[0]} className='w-128 h-64 rounded-md opacity-80 hover:opacity-100 hover:scale-110 ease-out'></img>
      </div>
      <div className="row-start-2 flex justify-start">
        <img src={images[1]} className='w-128 h-64 rounded-md opacity-80 hover:opacity-100 hover:scale-110 ease-out'></img>
      </div>
      <div className="row-span-2 flex justify-center items-center">
        <div>
          <p className="text-center text-9xl tracking-tight text-green-300 font-sans">brahmiLang</p><br/>
